...
#[derive(Debug)]
pub struct FileStorageProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FileStorageProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FileStorage processing");
    
    let mut processor = FileStorageProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FileStorageProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FileStorageProcessor::new(false);
